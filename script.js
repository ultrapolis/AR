...
const worldContainer = document.querySelector('#world-container'); // Контейнер 3-й модели
const freeModel = document.querySelector('#free-model'); // Сама 3-я модель
...
// 6. УНИВЕРСАЛЬНОЕ ВРАЩЕНИЕ (Для обеих моделей)
...
window.addEventListener('touchmove', (e) => {
    ...
    // Определяем, какую модель крутить в зависимости от того, что видит камера
